...
public class Retry  implements IRetryAnalyzer {
	...
	private static final Logger LOG = (Logger) LogManager.getLogger("Retry.class");// logger is untialized to log and track retry attempt using log4
	private static final int maxTry = 0; //max number of interface
	private int count = 0; //how many time the retry attempted for the current test case
